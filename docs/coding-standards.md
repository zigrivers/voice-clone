...
from voice_clone.database import get_session
...
# Factory fixture
@pytest.fixture
def make_voice_clone(db_session: AsyncSession) -> Callable[..., VoiceClone]:
    """Factory for creating test voice clones."""
    async def _make_voice_clone(
        name: str = "Test Clone",
        description: str | None = None,
        **kwargs: Any,
    ) -> VoiceClone:
        clone = VoiceClone(name=name, description=description, **kwargs)
        db_session.add(clone)
        await db_session.flush()
        await db_session.refresh(clone)
        return clone

    return _make_voice_clone
```

```python
# tests/test_voice_clones.py
...
class TestVoiceCloneEndpoints:
    ...
    async def test_create_voice_clone(self, client: AsyncClient) -> None:
        """Test successful voice clone creation."""
        response = await client.post(
            "/api/v1/voice-clones",
            json={"name": "My Clone", "description": "Test description"},
        )
    ...
    async def test_create_duplicate_name_fails(
        self,
        client: AsyncClient,
        make_voice_clone: Callable,
    ) -> None:
        """Test that duplicate names return 409."""
        await make_voice_clone(name="Existing")
    ...
    async def test_get_nonexistent_returns_404(self, client: AsyncClient) -> None:
        """Test that missing clone returns 404."""
        response = await client.get("/api/v1/voice-clones/00000000-0000-0000-0000-000000000000")
...
### 10.2 TypeScript Testing

```typescript
// __tests__/components/VoiceCloneCard.test.tsx
...
```typescript
// __tests__/hooks/useVoiceClone.test.ts
...
describe('useVoiceClone', () => {
  it('fetches clone successfully', async () => {
